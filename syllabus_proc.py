...
class Topic:
    name: str
    confidence: float = 1.0  # Default confidence to 1.0
...
{text}"""
            ...
            response = self.openai.chat.completions.create(
                model=self.model,
                messages=[
                    {"role": "system", "content": "You are an expert at identifying topics from syllabi. Respond with only the topics in order."},
            ...
            try:
                ...
                return [Topic(name=topic) for topic in topics_list]
